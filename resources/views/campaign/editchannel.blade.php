...
<section class="content-header">
    <h1><i class="fa fa-glass"></i> Edit Campaign Channels &nbsp;&nbsp;</h1>
        <ol class="breadcrumb">
...
<section id="content_section" class="content">            
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" style="padding:20px 0px 0px 0px">
                ...
                <form class="form-horizontal" method="post" id="form" enctype="multipart/form-data" action="/campaign/channel/save/{{$campaign_id}}/{{$channel->id}}">
                    ...
                    <div class="box-body" id="parent-form-area">                    
						...
						<div class="form-group header-group-0 " id="form-group-chairman" style="">
						    ...
						    <div class="col-sm-10">
						        <input type="text" title="Chairman" required="" maxlength="255" class="form-control" name="chairman" id="chairman" value="{{$channel->chairman}}">
						        <div class="text-danger"></div>
						        <p class="help-block"></p>
						    </div>
						</div>  
						...
						<div class="form-group header-group-0 " id="form-group-description" style="">
						    ...
						    <div class="col-sm-10">
						        <input type="text" title="Description" required="" maxlength="255" class="form-control" name="description" id="description" value="{{$channel->description}}">
						        <div class="text-danger"></div>
						        <p class="help-block"></p>
						    </div>
						</div>  
