...
<section class="content-header">
    <h1><i class="fa fa-glass"></i> Edit Campaign &nbsp;&nbsp;</h1>
        <ol class="breadcrumb">
    ...
    <div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" style="padding:20px 0px 0px 0px">
                <form class="form-horizontal" method="post" id="form" enctype="multipart/form-data" action="/campaign/{{ $campaign->id }}">
                    ...
                    <div class="box-body" id="parent-form-area">                    
	                    <div class="form-group header-group-0 " id="form-group-name" style="">
							...
							<div class="col-sm-10">
						        <input type="text" title="Name" required="" placeholder="You can only enter the letter only" maxlength="70" class="form-control" name="name" id="name" value="{{$campaign->name}}">
						...
						<div class="form-group header-group-0 " id="form-group-message" style="">
						    ...
						    <div class="col-sm-10">
						        <input type="text" title="Message" required="" maxlength="255" class="form-control" name="message" id="message" value="{{$campaign->message}}">
						        <div class="text-danger"></div>
						        <p class="help-block"></p>
						    </div>
						</div>    
		            ...
		            <div class="box-footer" style="background: #F5F5F5">
		                <div class="form-group">
		                    ...
		                    <div class="col-sm-10">                                              
		                    <a href="{{url('/campaign')}}" class="btn btn-default"><i class="fa fa-chevron-circle-left"></i> Back</a>
